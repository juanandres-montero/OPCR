...
}, "C:/Users/juanm/Documents/Respaldo/juanandres-montero/Obras P\xFAblicas de Costa Rica/OPCR/src/components/blog/BlogSideBar.astro", void 0);
...
const $$BlogContent = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<article class="prose-slate w-sm md:w-prose md:prose poppins"> <a href="/blog/" title="Back to blog">&larr; Volver a la página principal</a> <p class="text-slate text-sm md:text-base">
Fecha de publicación ${content.pubDate} por ${content.author} </p> ${renderSlot($$result, $$slots["default"])} <p class="text-slate">Escrito por ${content.author}</p> <a href="/blog/" title="Back to blog">&larr; Volver a la página principal</a> </article>`;
}, "C:/Users/juanm/Documents/Respaldo/juanandres-montero/Obras P\xFAblicas de Costa Rica/OPCR/src/components/blog/BlogContent.astro", void 0);
...
}, "C:/Users/juanm/Documents/Respaldo/juanandres-montero/Obras P\xFAblicas de Costa Rica/OPCR/src/layouts/BlogPost.astro", void 0);
